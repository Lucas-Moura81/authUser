...
@RequestMapping("/instructors") // 1 nivel de maturidade 
@Log4j2
public class InstructorController {
	...
	public ResponseEntity<Object> salveSubscriptionInstructor(@RequestBody @Valid InstructorDto instructorDto) {
